...
// Note: Horner scheme should not be empolyed here !!!
...
//
// Closed-form solutions are empolyed for reduced_order < 5
// isolation = true:
//                    Sturm' theory and some geometrical property are empolyed to bracket each root
//                    Safe-Newton is empolyed to shrink the interval efficiently
// isolation = false:
